...
import { Box, CircularProgress, Container, FormControl, Grid, IconButton, OutlinedInput, Typography } from '@mui/material';
...
const Characters: React.FC = () => {
    ...
    const { nextPage, previousPage, currentPage, error } = useAppSelector((state) => state.people);
        ...
        <Container>
            {error ? (
                <Box display="flex" justifyContent="center" alignItems="center" height="100vh" flexDirection="column">
                    <ReportGmailerrorredIcon sx={{ color: 'yellow' }} fontSize="large" />

                    <Typography>Erro ao buscar personagens, tente novamente!</Typography>
                </Box>
            ) : (
